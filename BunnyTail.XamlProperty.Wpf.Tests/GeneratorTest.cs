...
public sealed class GeneratorTest
{
    ...
    public void DefaultValueMemberIsApplied()
    {
        ...
        // Assert
        Assert.Contains("new global::System.Windows.PropertyMetadata(DefaultText)", generated, StringComparison.Ordinal);
    }
    ...
    // ------------------------------------------------------------
    [Fact]
    public void FrameworkPropertyChangedCallbackIsMethodGroup()
    {
        // Arrange
        const string source =
            """
        ...
        // Assert
        Assert.Contains("new global::System.Windows.PropertyMetadata(OnTextChanged)", generated, StringComparison.Ordinal);
    }
    ...
    public void FrameworkCoerceCallbackIsMethodGroup()
    {
        ...
        const string source =
            ...
            public partial class TestElement : DependencyObject
            {
                ...
                private static object CoerceScale(DependencyObject d, object baseValue) => baseValue;
            }
            """;
    ...
    [Fact]
    public void FrameworkValidateCallbackIsMethodGroup()
    {
        // Arrange
        const string source =
            """
            ...
            public partial class TestElement : DependencyObject
            {
                ...
                private static bool ValidateScale(object value) => true;
            }
            """;
