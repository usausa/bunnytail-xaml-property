...
internal static class Diagnostics
{
    ...
    public static DiagnosticDescriptor InvalidDefaultValueMember { get; } = new(
        ...
        messageFormat: "[StyledProperty] DefaultValueMember is not a static member of the property type. member=[{0}]",
        category: "Usage",
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static DiagnosticDescriptor InvalidTargetType { get; } = new(
        ...
        messageFormat: "[AttachedProperty] target type is not AvaloniaObject. method=[{0}]",
        category: "Usage",
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
}
